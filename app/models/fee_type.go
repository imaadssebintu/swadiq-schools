...
// FeeType represents a type of fee (e.g., tuition, library, sports).
type FeeType struct {
	...
	IsRequired       bool                   `json:"is_required" gorm:"default:true;index"`
	...
	Assignments []*FeeTypeAssignment `json:"assignments,omitempty" gorm:"foreignKey:FeeTypeID;references:ID"`
}
